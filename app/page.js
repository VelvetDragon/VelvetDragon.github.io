    ...
    <main className={`${darkMode ? "bg-gray-900 text-white" : "bg-white text-gray-800"} px-10 md:px-20 lg:px-40`}>
      <section className="min-h-screen">
        <nav className="py-10 mb-12 flex justify-between">
          <h1 className="text-xl">Suwan Aryal</h1>
      ...
      {/* Skills Section */}
      <section className="py-16 bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 text-white rounded-3xl shadow-lg mb-16 mt-20 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Languages */}
          <div className="text-center p-6 bg-white bg-opacity-10 rounded-xl hover:scale-105 transform transition duration-500 ease-in-out ml-5">
          ...
          {/* Frameworks */}
          <div className="text-center p-6 bg-white bg-opacity-10 rounded-xl hover:scale-105 transform transition duration-500 ease-in-out mr-5 ml-5">
          ...
          {/* Machine Learning */}
          <div className="text-center p-6 bg-white bg-opacity-10 rounded-xl hover:scale-105 transform transition duration-500 ease-in-out ml-5 mr-5">
      ...
      <section className="my-20">
        <h3 className="text-3xl py-1 text-center font-bold">Projects</h3>
        <div className={`text-md py-5 leading-8 text-gray-800 dark:text-gray-300`}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {/* Potato Disease Classification */}
            <div className="relative text-center shadow-lg p-10 rounded-xl bg-gradient-to-r from-green-400 to-blue-500 text-white overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black to-black flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                <a href="https://github.com/your-potato-repo-link" target="_blank" rel="noopener noreferrer" className="text-5xl text-white">
                  <AiFillGithub />
                </a>
              </div>
            </div>
            ...
            <div className="relative text-center shadow-lg p-10 rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 text-white overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black to-black flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                <a href="https://github.com/VelvetDragon/Password-Strength-Prediction-using-NLP" target="_blank" rel="noopener noreferrer" className="text-5xl text-white">
                  <AiFillGithub />
                </a>
              </div>
            </div>
            ...
            <div className="relative text-center shadow-lg p-10 rounded-xl bg-gradient-to-r from-yellow-400 to-red-500 text-white overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black to-black flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                <a href="https://github.com/VelvetDragon/Churn-Analysis-and-Prediction" target="_blank" rel="noopener noreferrer" className="text-5xl text-white">
                  <AiFillGithub />
                </a>
              </div>
            </div>
            ...
            {/* Sentiment Analysis */}
            <div className="relative text-center shadow-lg p-10 rounded-xl bg-gradient-to-r from-blue-400 to-indigo-500 text-white overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black to-black flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                <a href="https://github.com/VelvetDragon/Sentiment-Analysis-Amazon-Reviews" target="_blank" rel="noopener noreferrer" className="text-5xl text-white">
                  <AiFillGithub />
                </a>
              </div>
            </div>
            ...
            <div className="relative text-center shadow-lg p-10 rounded-xl bg-gradient-to-r from-purple-400 to-pink-500 text-white overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black to-black flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                <a href="https://github.com/VelvetDragon/Flight-Ticket-Price-Prediction-Using-ML" target="_blank" rel="noopener noreferrer" className="text-5xl text-white">
                  <AiFillGithub />
                </a>
              </div>
            </div>
            ...
            <div className="relative text-center shadow-lg p-10 rounded-xl bg-gradient-to-r from-teal-500 to-green-600 text-white overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black to-black flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                <a href="https://github.com/your-sales-repo-link" target="_blank" rel="noopener noreferrer" className="text-5xl text-white">
                  <AiFillGithub />
                </a>
              </div>
            </div>
